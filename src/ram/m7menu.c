  ...
  if (ndisp == 7)
	  ...
	  if (dcopy ())
	    {
	      ...
	      vcputsv (menuob, 64, MHILITE, mbak,
		       mrowcol[M_COPY][0] + 1, mrowcol[M_COPY][1], bfs, 14);
	...
	{			/* not verified, cancel it */
      ...
      vcputsv (menuob, 64, mbcv, mbak,
	       mrowcol[M_COPY][0], mrowcol[M_COPY][1], mtexts[M_COPY], 14);
...
*/
	  ...
	  if (dformat (DENSITY))
	    {
	      ...
	      vcputsv (menuob, 64, MHILITE, mbak,
		       mrowcol[M_FORM][0] + 1, mrowcol[M_FORM][1], bfs, 14);
	...
	{			/* not verified, cancel it */
      ...
      vcputsv (menuob, 64, mbcv, mbak,
	       mrowcol[M_FORM][0], mrowcol[M_FORM][1], mtexts[M_FORM], 14);
  ...
  for (i = 0; i < NLTYPES; i++)
    {
      ...
      vcputsv (menuob, 64, MLFILES, mbak, mfrc[i][0], mfrc[i][1], buf, 14);
    }
}
