      ...
      if (CM_USTR ("names"))
	{
	  ...
	  for (aux1 = 0; aux1 < 128; aux1++)
	      ...
	      if (scores[aux1] NE E_NULL)
		{
		  ...
		  printf ("<%3d: ", aux1);
		  chptr = scname[aux1];
		  printf ("[$%08.8lx, $%08.8lx] ", scores[aux1], chptr);
...
*/
  if (CM_CHR ('/'))
    {				/* output note begin and end, given value */
