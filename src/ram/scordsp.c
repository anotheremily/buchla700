...
char *sdisp[] = {		/* score display fixed text strings */
  ...
  /* 1 */
    "\200\201\202\203 1    2    3    4    5    6    7    8    9    \254    \255    \256    ",
  /* Group / Instrument */

  /* 2 */
    "\220\221\222\223  Pch/Hor  Mod/Vrt  Brth/LP  GPC/CV1  Pedal 1  Key Prs Group",
  /* Analog Source */
  ...
  /* 7 */
    "\224\225\226\227  0/+00.0  0/+00.0  0/+00.0  0/+00.0  0/+00.0  0/+00.0 # 00 ",
  /* Resolution / Value */
...
dclkmd ()
{
  ...
  vputs (obj8, 0, 29, "Clock", clkrun ? ((SD_CHNG << 4) | SDBG02) : SDW02ATR);
}
...
dsclk ()
{
  ...
  sprintf (bfs, "Clock Con %5.5s Src %5.5s ", clklbl[clkctl], clklbl[clksrc]);
...
*/
    ...
    case 13:			/* score */
      ...
      sprintf (bfs, "Score  %02.2d %16.16s ", curscor + 1, scname[curscor]);
