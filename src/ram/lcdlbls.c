...
/* forward references */
     ...
     short l_group (), l_dflt (), l_inst (), l_goto (), l_asgn (), l_adfl (),
  l_load ();
...
char *potlbls[] = {		/* LCD pot labels */
  ...
  /* 0 */
    "Locn  Level Ind 1 Ind 2 Ind 3 Frq 1 Frq 2 Frq 3 Frq 4 Ind 4 Ind 5 Ind 6 Filtr Reson",
  /* 1 */
    "Locn  Level Ind 1 Ind 2 Ind 3 Frq 1 Frq 2 Frq 3 Frq 4 Ind 4 Ind 5 Ind 6 Filtr Reson",
  /* 2 */
    "      Aux   Depth Rate  Inten CV 1  CV 2  CV 3  CV 4                               ",
  /* 3 */
    " 50    150   400    1k  2.5k    6k   15k   50    150   400    1k  2.5k    6k   15k ",
  /* 4 */
    "Locn  Level Ind 1 Ind 2 Ind 3 Frq 1 Frq 2 Frq 3 Frq 4 Ind 4 Ind 5 Ind 6 Filtr Reson",
  /* 5 */
    "Locn  Level Ind 1 Ind 2 Ind 3 Frq 1 Frq 2 Frq 3 Frq 4 Ind 4 Ind 5 Ind 6 Filtr Reson",
...
char *swtlbls[] = {		/* LCD switch labels -- ROMP ENABLED */
  ...
  /* 0 */
    "Quiet ROMP  Lamp  Clock  P/R  Go To Instr Asgmt Load              Other Voice Init ",
  /* 1 */
    "                                                                        Voice Init ",
  /* 2 */
  ...
  /* 4 */
    "                                                                         +00  Deflt",
  /* 5 */
    "Quiet ROMP  Lamp  Clock  P/R  Go To Instr Asgmt Load              Other Voice Deflt",
  /* 6 */
    "Quiet ROMP  Lamp  Clock  P/R                                                       ",
  /* 7 */
    "Quiet ROMP  Lamp                                Load                               "
};
#else
char *swtlbls[] = {		/* LCD switch labels -- ROMP DISABLED */

  /* 0 */
    "Quiet       Lamp  Clock  P/R  Go To Instr Asgmt Load              Other Voice Init ",
  /* 1 */
    "                                                                        Voice Init ",
  /* 2 */
  ...
  /* 4 */
    "                                                                         +00  Deflt",
  /* 5 */
    "Quiet       Lamp  Clock  P/R  Go To Instr Asgmt Load              Other Voice Deflt",
  /* 6 */
    "Quiet       Lamp  Clock  P/R                                                       ",
  /* 7 */
    "Quiet       Lamp                                Load                               "
};
#endif
     ...
     short stat, vce;
{
  ...
  if (articen[vce])
    {				/* turn articulation on if voice is enabled */
    ...
    {				/* ... or turn it off if voice is disabled */
