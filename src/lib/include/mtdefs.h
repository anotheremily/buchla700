...
typedef	struct	_mt_msg	{		/* Message */
...
typedef	struct	_mt_mbx	{		/* Mailbox */
...
typedef	struct	_mt_tcb	{		/* Task Control Block */
...
struct	_mt_str {			/* Multi-Tasker variable structure */
...
struct	_mt_def	{			/* Multi-Tasker interface block */
