						...
						if(flop >0) {
							...
							do {
								...
								if((dx == a) && (dy == b))
									...
									v_ellipse(handle,
										xwork+(dx * c_width)-x_border+x_offset,
										ywork+(dy * c_heigth)-y_border+y_offset,
										x_rad,y_rad);
...
screen()
{
	x_border = 6;		y_border = 6;
	x_rad = 9;		y_rad = 9;
	x_offset = 2;		y_offset = 2;
	c_wstart = 14;		c_hstart = 14;
	c_width = 20;		c_heigth = 20;
