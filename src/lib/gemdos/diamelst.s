******************************************************************************
*
* diamelst.s -- startup code for the C runtime library, aesbind, vdibind
* Version 3 -- 1988-05-03 -- D.N. Lynx Crowe
*
*	"It's not a diamond, it's a Diamel!", and this isn't Gem, either...
*	it just looks a lot like it.
*
*	Adds __cmdsz and __cmdln for access to raw command tail
*	
...
MINSTACK=4096		* minimum stack+heap size.  (used if __STKSIZ undefined)
...
*
*		An example using __STKSIZ in C is:
*
...
.globl	__cmdsz		* Command line length in __cmdln
.globl	__cmdln		* Command line image before __main gets it
...
*
	move.w	d0,__cmdsz	* Save length
	lea.l	__cmdln,a1	* Setup move to address
	bra	LynxL1		* Enter the loop
*
LynxL2:	move.b	(a2)+,(a1)+	* Move a byte
*
LynxL1:	dbf	d0,LynxL2	* Loop until they're moved
*
...
*
___pname:	.dc.b	'Diamel',0	* Program name
...
*
__cmdsz:	.ds.w	1	* Length of command line in __cmdln
__cmdln:	.ds.w	128	* Command line image before __main gets it
*
