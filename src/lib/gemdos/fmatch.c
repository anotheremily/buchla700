/*
   =============================================================================
	fmatch.c -- match file name to wildcard pattern
	Version 1 -- 1987-03-22

	Usenet public domain source code.
   =============================================================================
*/
...
#define LEFT_BR		'['	/* The '[' metacharacter */
#define RIGHT_BR	']'	/* The ']' metacharacter */
